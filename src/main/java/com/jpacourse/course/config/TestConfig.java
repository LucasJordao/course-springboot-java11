...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2020-06-20T19:57:01Z"), u1);
		Order o2 = new Order(null, Instant.parse("2020-07-21T12:32:12Z"), u2);
		Order o3 = new Order(null, Instant.parse("2020-07-22T08:42:00Z"), u1);
